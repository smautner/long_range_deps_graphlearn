...
are not abundand. An existing method is based on recombination of
graphs based on a graph grammar, not unlike a string grammar. 
We present an extension to these grammars which takes into account
a modified version of graphs. However, the modification needs to be
automaticaly generateable. We explore the application of this idea
