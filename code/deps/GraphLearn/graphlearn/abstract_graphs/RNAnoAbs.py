...
class NuRnaWrapper(Wrapper):
    '''

    '''
    def __init__(self, seq,stru,base_graph,vectorizer,ignore_inserts):
        '''
        :param seq:
        :param stru:
        :param base_graph:
        :param vectorizer:
        :param ignore_inserts:   no clue what this does..
        '''
        # these are used by wrapper
        self.vectorizer=vectorizer
        self._base_graph=base_graph

        # these i save just 4 fun
        self.sequence = seq
        self.structure= stru
        self.ignore_inserts=ignore_inserts
...
class RnaWrapper(AbstractWrapper):
    ...
    def abstract_graph(self):
        ...
        overwrites stuff in the AbstractWrapper class
        '''
