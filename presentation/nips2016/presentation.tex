...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item {\em core} induced by coarse level (dark green)
        \item {\em interface} is context of core at original level $\times$ context at coarse level
   \end{itemize}
    {\bf Note:} cores are now arbitrarily large\\
    interfaces are small, but model large parts
   \begin{figure}[ht]
        \centering
