...
\color{blue}The
dashed line indicates the performance of the sequence generator of
Infernal\footnote{Trained with RNAalifold structure given by muscle generated
alignment of the training set. Quality parameter (ext) set to maximum reliable value 3.91.}.
\color{black}
